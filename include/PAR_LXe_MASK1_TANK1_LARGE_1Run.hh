#ifndef PAR_LXe_MASK1_TANK1_LARGE_1Run_h
#define PAR_LXe_MASK1_TANK1_LARGE_1Run_h 1
...
class PAR_LXe_MASK1_TANK1_LARGE_1Run : public G4Run {

public:
  // constructor and destructor.
  //  vector of multifunctionaldetector name has to given to constructor.
  PAR_LXe_MASK1_TANK1_LARGE_1Run(const std::vector<G4String> mfdName);
  virtual ~PAR_LXe_MASK1_TANK1_LARGE_1Run();
